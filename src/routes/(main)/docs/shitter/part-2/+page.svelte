...
<section>
    ...
    <p>
        This ARG worked similarly to the previous Shitter ARG, where Shitter
        would randomly DM the members. This ARG did NOT get solved. Not because
        it was hard, but because

        <b>
            WHO IN THE ACTUAL HYPERARTICULATED BILABIAL-RHONTIC DELTANATED TRILL
            WOULD EVEN WANT TO SOLVE THIS??
        </b>

        Shitter already gave enough work for us to do, and now he wanted to put
        us in that pain all again.
    </p>

    <p>
        <i>
            (There was a server made by Shitter himself to spread clues and it
            had weird Han characters. Of course no one paid attention and it
            slowly got forgotten, because no one wanted to solve this
            shitfuckery. I am the only one who vividly remembers this server,
            but I forgot to take any screenshots. - Lanzoor)
        </i>
    </p>

    <p>And then Shitter leaves and is gone forever.</p>

    <Break height="5em" />

    <p>
        ...of course not we're only at Part 2 what are we even trying to hide at
        this point
    </p>
    ...
    <p>
        ...
        TO FUCKING COMMIT MORE MORE JUMP ON A BRIDGE AND EXPLODE.
    </p>
    ...
    <h2>
        HE TRIED TO JUSTIFY ALL OF HIS PREVIOUS ACTIONS BY MAKING AN EXCUSE
        ABOUT """POOR LIVING CONDITION."""
    </h2>

    <h1 style="font-size: 5em"><i>AGAIN.</i></h1>

    <p>
        Very predictable I know. Being the dumbest fuck Lanzoor is, he decided
    ...
    <p>
        <b>This would be the WORST MISTAKE EVER.</b> We had forgotten what this one
        hell of a Shitter did before. And of course, we still had a feeling that he
        would leave AGAIN in the distant future. (Again, you don't have dementia,
        this is the THIRD time. I know.)
    </p>

    <p>
        This is the longest period where Shitter didn't leave nor make shit
        ARGs. But secretly, he was constantly finding a reason to crash out,
        leave, and do that ARG stuff all over again.
    </p>
