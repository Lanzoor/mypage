...
<section>
    ...
    <ul>
        <li>
            <b>We / Us / Our</b> shall refer to Lanzaforge (the owner and operator
            of this service).
        </li>
        <li>
            <b>You / User</b> shall refer to any individual or entity using our services.
        </li>
        <li>
            <b>Service</b> shall refer to all websites, features, and content
            provided under this website, <code>lanzoor.dev</code>.
        </li>
        <li>
            <b>Legal Information</b> shall refer to this Terms of Service and the
            Privacy Policy.
        </li>
    </ul>
    ...
    <p>
        ...
        certain data, as described in our <a href="/privacy-policy"
            >Privacy Policy</a
        >.
    </p>
    ...
    <ul>
        ...
        <li>
            Reverse engineer, modify, or exploit the Service in ways not
            permitted by the Legal Information.
        </li>
    </ul>
    ...
    <ul>
        <li>
            Abuse, overload, or interfere with the normal operation of the
            Service.
        </li>
    </ul>
    ...
    <ul>
        <li>
            Use the Service for any illegal activity or to violate applicable
            laws.
        </li>
    </ul>
    ...
    <p>
        <b
            ...
            time, with or without notice, for any reason.</b
        ><br />
    ...
    <p>
        ...
        <a href="/legal#notices">this section</a>!
    </p>

    <p>
        Your continued use of the Service after such changes constitutes your
        acceptance of the updated Legal Information.
    </p>
</section>
